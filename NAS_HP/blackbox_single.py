...
width = float(sys.argv[indx + 2])
resolution = float(sys.argv[indx + 3])

# Batch size
batch_size = int(sys.argv[indx + 4])

# HPs
optimizer_choice = int(sys.argv[indx + 5])
arg1 = float(sys.argv[indx + 6])  # lr
arg2 = float(sys.argv[indx + 7])  # momentum
arg3 = float(sys.argv[indx + 8])  # weight decay
arg4 = float(sys.argv[indx + 9])
...
# Get 10% of dataset
train_indices = get_indx_balanced_train_subset(train_idx_dict, indexDataSubset)
test_indices = get_indx_balanced_test_subset(test_idx_dict, indexDataSubset)
