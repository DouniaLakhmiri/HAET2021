...
# New scheduler with longer period
...
print('Index seed:', indexDataSeed, 'batch_size: ', batch_size_arg, ' weight_decay: ', weight_decay_arg, ' lr: ',
      lr_arg, ' optimizer_choice: ', optimizer_choice)
...
while execution_time < 600:
    ...
    print(
        "Epoch {}, Execution time: {:.1f} Train accuracy: {:.3f}, Val accuracy: {:.3f}, Best val acc: {:.3f}, LR: {:.3f}".format(
            epoch, execution_time, tr_acc, te_acc, best_test_acc, lr))
    total_epochs += 1
    epoch += 1
